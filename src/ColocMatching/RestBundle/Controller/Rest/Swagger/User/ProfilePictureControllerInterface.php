...
interface ProfilePictureControllerInterface {
     ...
     *
     * @SWG\Get(path="/users/{id}/picture", operationId="rest_get_user_picture", tags={ "Users - profile picture" },
     ...
     *   tags={ "Users - profile picture" }, consumes={ "multipart/form-data" }, security={
     *     { "api_token" = {} }
     *   },
     *   @SWG\Parameter(in="path", name="id", type="integer", required=true, description="The user identifier"),
     *   @SWG\Parameter(
     ...
     *   @SWG\Response(
     *     response=200, description="User found and picture uploaded",
     *     @SWG\Schema(ref="#/definitions/ProfilePicture")),
     ...
     *   tags={ "Users - profile picture" }, security={
     *     { "api_token" = {} }
     *   },
     *   @SWG\Parameter(in="path", name="id", type="integer", required=true, description="The user identifier"),
