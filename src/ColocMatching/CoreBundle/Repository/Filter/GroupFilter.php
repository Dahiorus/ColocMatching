...
class GroupFilter extends PageableFilter implements Searchable {
    ...
    public function __toString() : string {
        return "GroupFilter (" . parent::__toString() . ") [withDescription=" . $this->withDescription . ", budgetMin="
            . $this->budgetMin . ", budgetMax=" . $this->budgetMax . ", status=" . $this->status . ", countMembers="
            . $this->countMembers . ", withPicture=" . $this->withPicture . "]";
    }
