...
namespace ColocMatching\CoreBundle\Controller\Rest\v1\Invitation;
...
use ColocMatching\CoreBundle\Controller\Rest\v1\Swagger\Invitation\UserInvitationControllerInterface;
...
class UserInvitationController extends RestController implements UserInvitationControllerInterface {
    ...
    public function getInvitationsAction(int $id, ParamFetcher $paramFetcher) {
        ...
        $response = $this->get("coloc_matching.core.response_factory")->createPageResponse($invitations,
    ...
    public function createInvitationAction(int $id, Request $request) {
        ...
        try {
            ...
            $response = $this->get("coloc_matching.core.response_factory")->createEntityResponse($invitation,
